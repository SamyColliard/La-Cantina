...
const Description = ({charactersInfo, charactersInfo1, charactersInfo2}) => {
    console.log("dddddddddddddd",charactersInfo)
    return (
        <div id="description">   
            <div className='div1'>
            ...
            Des fossiles de diabétique laissaient penser aux scientifiques que Tatooine avait été recouverte par un océan de sucre glace à l'instar de Kamino. 
                </p>
